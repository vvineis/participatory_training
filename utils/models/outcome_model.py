...
class OutcomeModel:
    """
    Class to train and evaluate an outcome prediction model."""
...
class CausalOutcomeModel:
    """
    Class to train and evaluate a causal outcome model."""
    
    def __init__(self, learner=None, control_name='C', random_state=4242):
        if learner is None:
